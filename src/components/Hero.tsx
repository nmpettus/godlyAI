      ...
      <div className="relative min-h-[1300px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 animate-fade-up pt-20">
          ...
          <div className="flex flex-col md:flex-row gap-4 md:gap-16 justify-center px-8 md:px-0">
            ...
            <Button variant="outline" className="bg-gradient-to-r from-[#e6e9f0] to-[#eef1f5] w-full md:w-[160px] h-[60px] text-lg rounded-full border-2 border-black text-black hover:opacity-90" onClick={() => navigate('/contact')}>
              Contact Us
            </Button>
          </div>
